...
int TEST_HEX_001(fuse_t *self)
{
    ...
    fuse_debugf(self,"TEST_HEX_001 utostr_hex uint8_t\n");
...
{
    // Cycle through all the uint8_t values
    fuse_debugf(self,"TEST_HEX_002 utostr_hex uint8_t bits=16\n");
...
{
    // Cycle through all the uint8_t values
    fuse_debugf(self,"TEST_HEX_003 utostr_hex uint8_t bits=12 upper\n");
