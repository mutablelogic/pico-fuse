 ...
 *
 * Soft reset the BME280 device, setting the device to its initial state
 *
...
bool bme280_read_raw(fuse_t *self, fuse_bme280_t *bme280, int32_t *temperature, int32_t *pressure, int32_t *humidity)
{
    ...
    if (mode == 0)
    {
        ...
        do
        {
            ...
            bme280_read_status(self, bme280, &measuring, &updating);
        } while (measuring || updating);
        if (tries > 6)
        {
            fuse_debugf(self, "bme280_read_raw: failed to measure within time limit\n");
            return false;
        }
    }
...
int32_t bme280_compensate_temperature(fuse_bme280_t *bme280, int32_t temperature, int32_t *fine)
{
    ...
    // Return the compensated temperature value, within the limits of -40C to +85C
...
uint32_t bme280_compensate_pressure(fuse_bme280_t *bme280, int32_t pressure, int32_t fine)
{
    ...
    p = (uint32_t)((int32_t)p + ((var1 + var2 + bme280->P7) >> 4));
    if (p < 30000)
    {
        p = 30000;
    }
...
uint32_t bme280_compensate_humidity(fuse_bme280_t *bme280, int32_t humidity, int32_t fine)
{
    ...
    v_x1_u32r = (((((humidity << 14) - (((int32_t)bme280->H4) << 20) - (((int32_t)bme280->H5) * v_x1_u32r)) +
                   ((int32_t)16384)) >>
                  15) *
                 (((((((v_x1_u32r * ((int32_t)bme280->H6)) >> 10) * (((v_x1_u32r *
                                                                       ((int32_t)bme280->H3)) >>
                                                                      11) +
                                                                     ((int32_t)32768))) >>
                     10) +
